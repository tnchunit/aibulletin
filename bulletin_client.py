...
class BulletinClient:
    ...
    def download_bulletin(self, bid, output_root="d:\\agy\\20260913\\downloads", screenshot_path=None, fallback_meta=None):
        """
            ...
            if form:
                ...
                for att in attachments:
                    ...
                    try:
                        ...
                        if att_res.status_code == 200 and 'content-disposition' in att_res.headers:
                            disp = att_res.headers['content-disposition']
                            fname = att['filename']
                            if 'filename=' in disp:
